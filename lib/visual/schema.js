export const REQUIRED_CORPUS_SOURCES = ['The Metropolitan Museum of Art', 'Rijksmuseum', 'Art Institute of Chicago', 'Smithsonian'];
...
export function validateIndexManifest(manifest) {
  ...
  for (const source of REQUIRED_CORPUS_SOURCES) if (!manifest.sources?.includes(source)) throw new Error('INDEX_SOURCE_MISSING');
