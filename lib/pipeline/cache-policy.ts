...
export function cacheClassFor(result: Pick<IdentificationResult, "state"> & Partial<Pick<Extract<IdentificationResult, { state: "MATCH" | "NO_MATCH" }>, "degraded">>): CacheClass {
